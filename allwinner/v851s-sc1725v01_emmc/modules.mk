...
#  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor/gc0406_mipi.ko    
#  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor_power/sensor_power.ko
  ...
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io gc2053_mipi gc2023_mipi gc0406_mipi vin_v4l2 gslX680new)
endef
