...
define KernelPackage/vin-v4l2
  ...
  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor/sc4336_mipi.ko
#  FILES+=$(LINUX_DIR)/drivers/media/platform/sunxi-vin/modules/sensor_power/sensor_power.ko
  ...
  AUTOLOAD:=$(call AutoProbe,videobuf2-core videobuf2-dma-contig videobuf2-memops videobuf2-v4l2 vin_io gc2053_mipi sc4336_mipi vin_v4l2)
endef
